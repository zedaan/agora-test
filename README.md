...
5. **Update the `join` method to fetch a token**
...
2. In your browser, navigate to the [Agora web demo](http://localhost:3000) and update _App ID_, _Channel_, and _Token_ with the values for your temporary token, then click **Join**.
...
- [renewToken](https://docs.agora.io/en/video-legacy/API%20Reference/web/globals.html)
